This project is an ETL (Extract, Transform, Load) pipeline that extracts e-commerce transaction data and Telegram chat messages, cleans and transforms them, and loads them into a PostgreSQL database.
#Features
